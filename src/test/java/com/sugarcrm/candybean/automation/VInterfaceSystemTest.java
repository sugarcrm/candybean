...
public class VInterfaceSystemTest {
	...
	public static void first() throws Exception {
		...
		String relPropsPath = curWorkDir + File.separator + "src"
				+ File.separator + "test" + File.separator + "resources";
<<<<<<< HEAD:src/test/java/com/sugarcrm/voodoo/automation/VInterfaceSystemTest.java
...
>>>>>>> dev:src/test/java/com/sugarcrm/candybean/automation/VInterfaceSystemTest.java
		iface.start();
	}
