...
public class ConfigurationUnitTest {
	...
	public void createAndLoadConfigurationTest() {
		...
		Assert.assertEquals("Values not equal, assertion failed!", "root", config1.getProperty("dbuser", "wrongvalue"));
		Assert.assertEquals("Values not equal, assertion failed!", "root", config1.getProperty("dbpassword", "wrongvalue"));
		// Checking if the keys/values exist in config2
		Assert.assertEquals("Values not equal, assertion failed!", "10.8.31.10", config2.getProperty("database", "wrongvalue"));
		Assert.assertEquals("Values not equal, assertion failed!", "translator", config2.getProperty("dbuser", "wrongvalue"));
		Assert.assertEquals("Values not equal, assertion failed!", "Sugar123!", config2.getProperty("dbpassword", "wrongvalue"));
