...
public class Contacts {
	...
	public static void create(Sugar sugar, IInterface iface, Contact contact) throws Exception {
		...
		iface.getControl(sugar.getHook("accountsearch_textfield_name")).halt(4);
		...
		iface.getControl(sugar.getHook("accountsearch_link_firstitem")).halt(4);
		...
		iface.getControl(sugar.getHook("contacts_textfield_portalname")).halt(4);
	...
	public static void deleteAll(Sugar sugar, IInterface iface) throws Exception {
		...
		iface.getControl(sugar.getHook("contactsearch_checkbox_selectall")).halt(4);
		iface.getControl(sugar.getHook("contactsearch_checkbox_selectall")).click();
		iface.getControl(sugar.getHook("contactsearch_button_deleteall")).halt(4);
