...
//		Contact Name -> contact1, Account Name -> account1, Portal Name -> PortalTest1, Password-> a, check box "Portal Active"
		...
		account = (new AccountBuilder("acct_cwarmbold")).build();
...
//		4. Fill all mandatory fields and click "Save" button.
		CaseBuilder portalCB = new CaseBuilder("portalCase", this.account);
		CaseBuilder sugarCB = new CaseBuilder("sugarCase", this.account);
