 ...
 * will build a {@link SeleniumBrowserAutoface} based on the platform specified in the configuration. An appropriate platform-specific
 * driver is instantiated for use to write tests.
 *
 */
public abstract class SeleniumBrowserAutoface extends BrowserAutoface {
	
	public WebDriver wd = null;
	private Stack<Pair<Integer, String>> windows = new Stack<Pair<Integer, String>>();
	
	protected SeleniumBrowserAutoface(Type iType) throws CandybeanException {
		super(iType);
	}
